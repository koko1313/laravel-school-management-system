...
class SessionGradesController extends Controller {
    ...
    public function index() {
        ...
        $all_grades = SessionGrade::getAll();
    ...
    public function store(Request $req) {
        ...
        try {
            $grade->save();
            return redirect()->route('session_grades')->with('success', Lang::get('constants.success_messages.grade.added'));
    ...
    public function edit($egn, $subject_id, $grade_id, $for_class) {
        ...
        $grade = SessionGrade::get($egn, $subject_id, $grade_id, $for_class);
    ...
    public function update(Request $req) {
        ...
        try {
            ...
            > 0) return redirect()->route('session_grades')->with('success', Lang::get('constants.success_messages.grade.updated'));
