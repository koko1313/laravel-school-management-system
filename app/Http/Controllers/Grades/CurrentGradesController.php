...
class CurrentGradesController extends Controller {
    ...
    public function index() {
        ...
        $all_grades = CurrentGrade::getAll();
        $terms = Term::getAll();
    ...
    public function store(Request $req) {
        ...
        try {
            $grade->save();
            return redirect()->route('current_grades')->with('success', Lang::get('constants.success_messages.grade.added'));
    ...
    public function edit($egn, $subject_id, $grade_id, $term_id, $for_class) {
        ...
        $grade = CurrentGrade::get($egn, $subject_id, $grade_id, $term_id, $for_class);
    ...
    public function update(Request $req) {
        ...
        try {
            ...
            > 0) return redirect()->route('current_grades')->with('success', Lang::get('constants.success_messages.grade.updated'));
